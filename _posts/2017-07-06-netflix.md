...
Since then a lot has changed and know they record every aspect of our viewing behavior. <em>Location, date, time, device, pausing, fast-forwarding, browsing, scrolling, ratings.</em> All of this user-events have an effect on what is recommended and how the surface of the app looks like. For all of you long-term subscribers, you might have noticed, that a few months ago they changed their rating-system from 5-stars to a simple like/dislike.  
