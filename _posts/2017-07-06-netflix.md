...
Since then a lot has changed and know they record every aspect of our viewing behavior. <em>Location, date, time, device, pausing, fast-forwarding, browsing, scrolling, ratings.</em> All of this user-events have an effect on what is recommended and how the surface of the app looks like.  
