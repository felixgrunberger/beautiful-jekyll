...
Actually it is quite hard to think of anything special. At least for me. So, I really appreciate Netflix´s way to suggest content and apparently many others do: <strong>70% of what people watch on Netflix is based on their recommendation algorithm</strong>. That´s a lot.  

<h2>How does it work and why is Netflix so good at it?</h2>
The basic idea of recommendation is: <em>Users that had similar interests in the past, will also have similar interests in the future.</em> So, in simple words, Netflix´s algorithm is based on the fact, that there are people around the globe with a similar taste in movies.  
